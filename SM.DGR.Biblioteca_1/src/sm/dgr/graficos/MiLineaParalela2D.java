...
*@version 16/6/1015
*Clase MiLineaParalela2D que extiende de DGRShape, lo cual tiene los atributos de la clase DGRShape
*@see  DGRShape
 */
...
public class MiLineaParalela2D extends DGRShape{
    ...
    boolean relleno;
    ArrayList puntosX = new ArrayList();
    ArrayList puntosY = new ArrayList();
    ...
    */
    ...
    public MiLineaParalela2D(Point pt1,Point pt2, double ancho, double alto, Color color,boolean relleno, boolean c, int st,int tipotrazo ,boolean r,boolean grad,boolean ang,Color c1, Color c2,float gradual, BufferedImage bff){
        this.setColor(color);
       ...
       trazolibre.moveTo(p1.x, p1.y);
        trazolibre.lineTo(p2.x, p2.y);

        trazolibre.moveTo(p1.x+10, p1.y+10);
        trazolibre.lineTo(p2.x+10, p2.y+10);
        
        
        for (double i =0 ; i < puntosX.size();i++){
            for (double j =0 ; j < puntosY.size();j++){
                trazolibre.lineTo(i, j);
            }
        }
        /*for (int i = 0 ; i < points.length; i ++){
            estrella.lineTo(points[i][0], points[i][1]);
        }*/
        trazolibre.closePath();
    }
    ...
    */    
    ...
    /**
    *Metodo getPath
    *Devuelve el objeto GeneralPath
    *@return Rectangle2D.Double
    */  

    public GeneralPath getTrazolibre() {
        return trazolibre;
    }
    ...
    */
    ...
    public boolean contains(Point2D p) {
        return trazolibre.contains(p);
    }
    
    /**
    *Metodo setPosicion
    *@param p 
    *Asigna nueva posicion a la linea
    */
    
    public void setPosicion(Point2D p){
        trazolibre.lineTo(p.getX(), p.getY());
    }

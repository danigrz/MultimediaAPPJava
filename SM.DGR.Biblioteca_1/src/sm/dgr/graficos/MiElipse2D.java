...
*@version 16/6/1015
*Clase MiElipse2D que extiende de DGRShape, lo cual tiene los atributos de la clase DGRShape
*@see  DGRShape
 */

public class MiElipse2D extends DGRShape{
    boolean relleno;
    ...
    *@param ang Boolean Angulo del gradiente; true = vertical; false = horizontal
    *@param c1 Color Color 1 del gradiente
    *@param c2 Color Color 2 del gradiente
    ...
    */
    ...
    public MiElipse2D(double x, double y, double ancho, double alto, Color color,boolean relleno, boolean c, int st,int tipotrazo ,boolean r,boolean grad,boolean ang,Color c1, Color c2,float gradual, BufferedImage bff){
        this.setColor(color);
    ...
    /**
    *Metodo setAtributos Asigna atributos a un objeto ya creado, se usa en la modificación
    *@param color Color
    *@param relleno Boolean
    *@param c Boolean, contiene el valor booleano de composite/transparencia para el objeto
    *@param st Stroke
    *@param r Boolean del alisado de la imagen (RenderingHints)
    *@param grad Boolean del gradiente del objeto
    *@param ang Boolean del angulo del gradiente
    ...
    */
    ...
    public void setGradiente(boolean g) {
        this.gradiente = g;
    ...
    */
    ...
    /**
    *Metodo getElipse
    *Devuelve el objeto Ellipse2D.Double

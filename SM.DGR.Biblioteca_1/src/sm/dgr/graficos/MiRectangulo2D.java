...
*@version 16/6/1015
*Clase MiRectangulo2D que extiende de DGRShape, lo cual tiene los atributos de la clase DGRShape
*@see  DGRShape
 */


public class MiRectangulo2D extends DGRShape{
    boolean relleno;
    ...
    */
    ...
    public MiRectangulo2D(double x, double y, double ancho, double alto, Color color,boolean relleno, boolean c, int st,int tipotrazo ,boolean r,boolean grad,boolean ang,Color c1, Color c2,float gradual, BufferedImage bff){
        this.setColor(color);
        ...
        Rectangulo.setFrame(x, y, ancho, alto);  
    }

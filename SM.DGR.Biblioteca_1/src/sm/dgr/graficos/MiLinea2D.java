...
import java.awt.image.BufferedImage;
    ...
    *@version 16/6/1015
    *Clase MiLinea2D que extiende de DGRShape, lo cual tiene los atributos de la clase DGRShape
    *@see DGRShape
    *@see Linea2D
    */

public class MiLinea2D extends DGRShape{
    ...
    */    
    ...
    public MiLinea2D(Point p1,Point p2,Color color,boolean relleno, boolean c, int st,int tipotrazo ,boolean r,boolean grad,boolean ang,Color c1, Color c2,float gradual, BufferedImage bff){
        Linea = new Linea2D(p1,p2);
